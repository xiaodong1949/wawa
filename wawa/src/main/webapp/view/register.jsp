	...
	<div class="container">
		<form role="form" class="form-signin"
			...
			<input type="password" class="form-control" id="password1"
				...
				placeholder="<spring:message code="sys.navbar.password1" />"
				required> <input type="text" class="form-control" id="email"
				name="email" value=""
				placeholder="<spring:message code="sys.navbar.email" />">
